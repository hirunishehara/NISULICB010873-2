if (window.location.href == "http://127.0.0.1:5500/BUY.html") {
...
localStorage.setItem("local-date", document.getElementById('summary-date').innerText);
localStorage.setItem("local-time", document.getElementById('summary-time').innerText);
localStorage.setItem("local-duration", document.getElementById('summary-duration').innerText);
localStorage.setItem("local-tickets", document.getElementById('summary-tickets').innerText);
localStorage.setItem("local-total", document.getElementById('summary-total').innerText);
...
if (window.location.href == "http://127.0.0.1:5500/Confirm.html") {
